...
def register():
     if request.method == 'POST' :
        ...
        print(account)
        message = Mail(from_email='saruthishon17@gmail.com',to_emails=session['email'],subject="Nutrition Assistant FREE - Registration",html_content='<b>Nutrition Assistant FREE welcomes you</b><br/><p>Your account has been registered successfully</p>')
        try:
