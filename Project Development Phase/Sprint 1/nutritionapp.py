...
def register():
     if request.method == 'POST' :
        ...
        message = Mail(from_email='saruthishon17@gmail.com',to_emails=email,subject="Nutrition Assistant FREE - Registration",html_content='<b>Nutrition Assistant FREE welocmes you</b><br/><p>Your account has been registered successfully</p>')
        try:
            sg=SendGridAPIClient('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')
